...
import org.correomqtt.plugin.systopic.controller.SysTopicButtonController;
...
public class SysTopicExtension implements MainToolbarHook {
    ...
    public void onInstantiateMainToolbar(String connectionId, HBox controllViewButtonHBox, int indexToInsert) {
        ...
        SysTopicPlugin.loadFXML("/org/correomqtt/plugin/systopic/controller/sysTopicButton.fxml", controller);
